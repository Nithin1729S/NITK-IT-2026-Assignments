...
int main()
{
    ...
    do
    {
        ...
        else if (rA < minDim || rB < minDim || cA < minDim|| cB < minDim)
            printf("Minimum row and column dimension is %d. Please enter a valid number.\n",minDim);
    } while (rA < minDim || rB < minDim || cA < minDim || cB < minDim);
    ...
    R=multiplyMatrices(A, B, R, rA, cA, rB, cB);

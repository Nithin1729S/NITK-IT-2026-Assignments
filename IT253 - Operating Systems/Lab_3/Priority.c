...
int main()
{
    ...
    for(j=0;j<n;)
    {
        ...
        for(i=0;i<n;i++)
        {
            ...
            {
                if(minCT>=processes[i].AT && minBT>processes[i].Priority)
                {
                    minBT=processes[i].Priority;
                    idx=i;
                }
                else if(minCT>=processes[i].AT && minBT==processes[i].Priority)
                {
